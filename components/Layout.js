              ...
              <div className="flex items-center space-x-2.5 overflow-hidden">
                ...
                {!isNavCollapsed && (
                  <div className="text-left whitespace-nowrap">
                    <p className="text-xs font-bold text-slate-900 dark:text-slate-100 leading-tight">John Doe</p>
                    <p className="text-[10px] text-mint-600 dark:text-mint-400 font-extrabold leading-tight">Lead Specialist</p>
                  </div>
                )}
              </div>
              {!isNavCollapsed && (
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="flex items-center space-x-2 text-xs">
                ...
                <span className="font-extrabold text-slate-900 dark:text-slate-100">{title || "Overview"}</span>
              </div>
            </div>
          </div>
              ...
              {showNotifications && (
                <div className="absolute right-0 mt-2 w-72 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl z-50 p-3.5 animate-fade-in">
                  <div className="flex items-center justify-between pb-2 border-b border-slate-100 dark:border-slate-800">
                    ...
                    <span className="text-[10px] text-mint-600 font-bold cursor-pointer hover:underline">Mark read</span>
                  </div>
