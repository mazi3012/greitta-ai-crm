...
const StatsCard = ({ title, value, change, changeType = "increase", icon: Icon, subtitle, progressPercent = 75 }) => {
  return (
    <div className="mint-card p-4 rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-gradient-to-br from-white via-white to-mint-50/30 dark:from-slate-900 dark:to-slate-900 transition-all hover:-translate-y-0.5">
